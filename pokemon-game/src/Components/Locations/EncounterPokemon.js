...
function EncounterPokemon(props) {
	...
	const [choosenPokemonHp, setChoosenPokemonHp] = useState(null);
	...
	if (!encounterPokemon || !encounterPokemon.name || !encounterPokemon.sprites.front_default) {
	...
	return (
		<>
			{choosenPokemonHp !== null && encounterPokemonHp !== null ? <Battle/> : (
